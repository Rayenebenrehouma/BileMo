 ...
 */
final class Version20231025092844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phone CHANGE description description VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE phone CHANGE description description TEXT NOT NULL');
    }
}
